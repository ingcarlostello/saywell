...
export function AppHeader({ actions }: AppHeaderProps) {
  return (
    <header className="sticky top-0 z-40 border-b border-border bg-header">
      ...
      {/* min-h, not h: the row grows with user text spacing (WCAG 1.4.12) instead of clipping the brand */}
      <div className="mx-auto flex min-h-16 max-w-7xl items-center justify-between gap-2 px-safe py-2 sm:min-h-20 sm:gap-3">
        <AppBrand />
