...
// <meta name="theme-color"> per theme (dark = the mockup header). Mirrored in index.html and in the manifest
// theme_color of vite.config.ts; scripts/check-arch.mjs fails if they drift apart.
