...
// wraps at its hyphens inside the capped column instead of forcing it wider.
export const syllablePillVariants = cva('h-auto min-h-7 min-w-16 py-0.5 text-center text-base wrap-break-word whitespace-normal', {
  variants: {
    stressed: {
